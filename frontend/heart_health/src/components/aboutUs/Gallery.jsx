...
const Gallery = () => {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      ...
      <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Here are some of the sample results.</p>
    </div>


    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">

      <Link to="#" class="group relative flex h-48 items-end justify-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-96">
